...
- **Vault dei segnaposto.** La mappatura va conservata in un **vault locale [cifrato](../glossario/cifratura.md)** a riposo (coerente con la [sicurezza](../requisiti/sicurezza.md), come per le [chiavi API](./gestione-api-key.md)), con segnaposto stabili e coerenti nel testo per non perdere le relazioni tra le entità.
